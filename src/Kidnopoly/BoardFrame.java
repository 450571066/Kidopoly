...
public class BoardFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Player01, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 460, -1, -1));
     ...
     */   
            ...
            if(currentPlayer==1)
            {
                ...
                {
                     JOptionPane.showMessageDialog(null, "You are in your compititors' land\n You will pay 1/4 of the land fee!","Kidsnopoly", JOptionPane.INFORMATION_MESSAGE);
